		...
		'tx_cwcontentscheduler_schedule_type' => array(
			...
			'config' => array(
				...
				'items' => array(
					...
					array('LLL:EXT:cw_content_scheduler/Resources/Private/Language/locallang.xlf:tt_content.tx_cwcontentscheduler_schedule_type.m', 'm'),
					array('LLL:EXT:cw_content_scheduler/Resources/Private/Language/locallang.xlf:tt_content.tx_cwcontentscheduler_schedule_type.h', 'h'),
					array('LLL:EXT:cw_content_scheduler/Resources/Private/Language/locallang.xlf:tt_content.tx_cwcontentscheduler_schedule_type.d', 'd'),
					array('LLL:EXT:cw_content_scheduler/Resources/Private/Language/locallang.xlf:tt_content.tx_cwcontentscheduler_schedule_type.w', 'w'),
				),
			),
		),
	), TRUE);
